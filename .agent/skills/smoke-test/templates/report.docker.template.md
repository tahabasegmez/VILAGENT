...
|----------|------|----------|
| vilagent-nginx | {{nginx_status}} | {{nginx_uptime}} |
| vilagent-frontend | {{frontend_status}} | {{frontend_uptime}} |
| vilagent-gateway | {{gateway_status}} | {{gateway_uptime}} |
...
### If the Test Passes
1. [ ] Visit http://localhost:2026 to start using VILAGENT
