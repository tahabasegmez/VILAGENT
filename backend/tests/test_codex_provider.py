"""Tests for vilagent.models.openai_codex_provider.CodexChatModel.
...
from vilagent.models.credential_loader import CodexCliCredential
...
def _make_model(**kwargs):
    ...
    with patch("vilagent.models.openai_codex_provider.load_codex_cli_credential", return_value=cred):
