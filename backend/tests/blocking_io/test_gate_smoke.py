...
async def test_gate_catches_unoffloaded_blocking_io_in_vilagent_module(tmp_path: Path) -> None:
    from vilagent.runtime.store._sqlite_utils import ensure_sqlite_parent_dir
