...
class TestDbRunEventStore:
    ...
    async def test_basic_crud(self, tmp_path):
        from vilagent.persistence.engine import close_engine, get_session_factory, init_engine
        from vilagent.runtime.events.store.db import DbRunEventStore
...
class TestMakeRunEventStore:
    ...
    async def test_db_backend_with_engine(self, tmp_path):
        ...
        from vilagent.persistence.engine import close_engine, init_engine
        from vilagent.runtime.events.store import make_run_event_store
...
class TestJsonlRunEventStore:
    @pytest.mark.anyio
    async def test_basic_crud(self, tmp_path):
        from vilagent.runtime.events.store.jsonl import JsonlRunEventStore
