"""Tests for vilagent.models.factory.create_chat_model."""
...
from vilagent.models import factory as factory_module
from vilagent.models import openai_codex_provider as codex_provider_module
...
def _make_app_config(models: list[ModelConfig]) -> AppConfig:
    return AppConfig(
        models=models,
        sandbox=SandboxConfig(use="vilagent.sandbox.local:LocalSandboxProvider"),
    )
...
def test_create_chat_model_resolves_patched_mimo_provider(model_id):
    from vilagent.models.patched_mimo import PatchedChatMiMo

    model = ModelConfig(
        name=f"{model_id}-thinking",
        display_name=f"{model_id} Thinking",
        description=None,
        use="vilagent.models.patched_mimo:PatchedChatMiMo",
        model=model_id,
        api_key="test-key",
...
def test_no_duplicate_kwarg_when_reasoning_effort_in_config_and_thinking_disabled(monkeypatch):
    ...
    model = ModelConfig(
        ...
        description=None,
        use="vilagent.models.patched_deepseek:PatchedChatDeepSeek",
