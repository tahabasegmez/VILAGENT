...
Bytedance/vilagent issue #3144: the hot-reload boundary is the contract
...
``vilagent.config.reload_boundary`` is the machine-readable source of truth;
...
from vilagent.config.reload_boundary import (
    STARTUP_ONLY_FIELDS,
    STARTUP_ONLY_PREFIX,
