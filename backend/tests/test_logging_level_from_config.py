...
from vilagent.config.app_config import apply_logging_level, logging_level_from_config
...
class TestApplyLoggingLevel:
    """Tests for ``apply_logging_level`` — verifies vilagent/app logger and handler levels."""
    ...
    def setup_method(self) -> None:
        ...
        self._original_vilagent_level = logging.getLogger("vilagent").level
    ...
    def teardown_method(self) -> None:
        ...
        logging.getLogger("vilagent").setLevel(self._original_vilagent_level)
        logging.getLogger("app").setLevel(self._original_app_level)

    def test_sets_vilagent_app_logger_levels(self) -> None:
        apply_logging_level("debug")
        assert logging.getLogger("vilagent").level == logging.DEBUG
    ...
    def test_defaults_to_info(self) -> None:
        ...
        assert logging.getLogger("vilagent").level == logging.INFO
