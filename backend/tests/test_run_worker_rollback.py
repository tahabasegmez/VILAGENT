...
from vilagent.runtime.runs.manager import RunManager
from vilagent.runtime.runs.schemas import RunStatus
from vilagent.runtime.runs.worker import (
    RunContext,
...
def test_agent_factory_supports_app_config_returns_false_when_signature_lookup_fails(monkeypatch):
    ...
    monkeypatch.setattr("vilagent.runtime.runs.worker.inspect.signature", lambda _obj: (_ for _ in ()).throw(ValueError("boom")))
