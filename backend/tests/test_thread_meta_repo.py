...
from vilagent.persistence.thread_meta import InvalidMetadataFilterError, ThreadMetaRepository
...
class TestThreadMetaRepository:
    ...
    async def test_search_metadata_all_unsafe_keys_raises(self, repo, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="vilagent.persistence.thread_meta.sql"):
...
class TestJsonMatchCompilation:
    ...
    def test_json_match_compiles_sqlite(self):
        ...
        from vilagent.persistence.json_compat import json_match
