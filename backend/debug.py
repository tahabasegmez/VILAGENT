...
Requirements:
    ...
    resolves vilagent-harness and app packages correctly:
...
async def main():
    ...
    # Delay the rest of the vilagent imports until *after* logging is installed
    # so that any import-time side effects (e.g. vilagent.agents starts a
    ...
    from vilagent.agents import make_lead_agent
    from vilagent.config.paths import get_paths
    from vilagent.mcp import initialize_mcp_tools
