...
from vilagent.config.paths import Paths, get_paths
...
def _build_owner_map_from_db(paths: Paths) -> dict[str, str]:
    ...
    db_path = paths.base_dir / "vilagent.db"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Migrate VILAGENT data to per-user layout")
