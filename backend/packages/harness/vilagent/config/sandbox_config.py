...
class SandboxConfig(BaseModel):
    ...
    AioSandboxProvider specific options:
        ...
        container_prefix: Prefix for container names (default: vilagent-sandbox)
    ...
    use: str = Field(
        default="vilagent.sandbox.local:LocalSandboxProvider",
        description="Class path of the sandbox provider (e.g. vilagent.sandbox.local:LocalSandboxProvider)",
    )
