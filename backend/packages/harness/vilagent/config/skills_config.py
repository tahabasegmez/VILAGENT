...
from vilagent.config.runtime_paths import project_root, resolve_path
...
class SkillsConfig(BaseModel):
    ...
    use: str = Field(
        default="vilagent.skills.storage.local_skill_storage:LocalSkillStorage",
    ...
    def get_skills_path(self) -> Path:
        ...
        Resolution order:
            ...
            2. ``VILAGENT_SKILLS_PATH`` environment variable
        ...
        if env_path := os.getenv("VILAGENT_SKILLS_PATH"):
