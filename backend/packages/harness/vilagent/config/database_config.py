...
Controls BOTH the LangGraph checkpointer and the VILAGENT application
...
({sqlite_dir}/vilagent.db) with WAL journal mode enabled on every
...
class DatabaseConfig(BaseModel):
    ...
    sqlite_dir: str = Field(
        default=".vilagent/data",
        description=("Directory for the SQLite database file. Both checkpointer and application data share {sqlite_dir}/vilagent.db."),
    )
    postgres_url: str = Field(
        ...
        description=(
            ...
            "Example: postgresql://user:pass@host:5432/vilagent "
    ...
    def sqlite_path(self) -> str:
        ...
        return os.path.join(self._resolved_sqlite_dir, "vilagent.db")
