...
consumer side of this module lives in ``vilagent.persistence.*``):
...
_current_user: Final[ContextVar[CurrentUser | None]] = ContextVar("vilagent_current_user", default=None)
