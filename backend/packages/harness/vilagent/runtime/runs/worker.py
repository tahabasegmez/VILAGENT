...
from vilagent.runtime.serialization import serialize
from vilagent.runtime.stream_bridge import StreamBridge
from vilagent.runtime.user_context import get_effective_user_id
from vilagent.tracing import inject_langfuse_metadata
    ...
    *,
    ...
    try:
        ...
        if event_store is not None:
            from vilagent.runtime.journal import RunJournal
        ...
        # Shared helper with ``VILAGENTClient.stream`` so both entry points stay
        ...
        inject_langfuse_metadata(
            ...
            environment=os.environ.get("VILAGENT_ENV") or os.environ.get("ENVIRONMENT"),
        )
...
def _try_extract_from_message(obj: Any) -> str | None:
    ...
    if isinstance(additional_kwargs, dict) and additional_kwargs.get("vilagent_error_fallback"):
    ...
    if isinstance(obj, dict):
        ...
        if isinstance(nested_kwargs, dict) and nested_kwargs.get("vilagent_error_fallback"):
