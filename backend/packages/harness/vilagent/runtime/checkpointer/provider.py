...
Usage::
    ...
    from vilagent.runtime.checkpointer.provider import get_checkpointer, checkpointer_context
...
from vilagent.config.checkpointer_config import CheckpointerConfig
...
POSTGRES_INSTALL = (
    "langgraph-checkpoint-postgres is required for the PostgreSQL checkpointer. Install the package extra with: pip install 'vilagent-harness[postgres]' (or use: uv sync --all-packages --extra postgres when developing locally)"
)
