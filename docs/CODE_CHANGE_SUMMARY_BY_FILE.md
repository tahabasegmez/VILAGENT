...
### 2. `backend/packages/harness/vilagent/agents/lead_agent/prompt.py`
...
### 4. `backend/packages/harness/vilagent/subagents/builtins/general_purpose.py`
...
### 25. `frontend/public/demo/threads/.../user-data/outputs/research_vilagent_20260201.md`

```diff
@@ -1,12 +1,3 @@
-<citations>
-{"id": "cite-1", "title": "VILAGENT GitHub Repository", "url": "https://github.com/bytedance/vilagent", "snippet": "..."}
-...（共 7 条 JSONL）
-</citations>
 # VILAGENT Deep Research Report
 
 - **Research Date:** 2026-02-01
```

- 删除文件开头的 `<citations>...</citations>` 整块（9 行），正文从 `# VILAGENT Deep Research Report` 开始。

---

### 26. `frontend/public/demo/threads/.../thread.json`

- **主要变更**：某条 `write_file` 的 `args.content` 中，将原来的「`<citations>...\n</citations>\n# VILAGENT Deep Research Report\n\n...`」改为「`# VILAGENT Deep Research Report\n\n...`」，即去掉 `<citations>...</citations>` 块，保留其后全文。
