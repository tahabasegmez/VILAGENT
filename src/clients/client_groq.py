"""
Groq-based client for VILAGENT.

This client uses Groq API to interact with the agent system.
"""
...
class VilagentGroqClient:
    ...
    async def initialize(self):
        ...
        # List tools
        print(f"\n{Fore.CYAN}🛠️  Loading tools (Groq compatible)...")
            ...
            try:
                ...
                while True:
                    ...
                    if not msg.tool_calls:
                        print(f"{Fore.GREEN}🤖 Vilagent (Groq): {Style.RESET_ALL}{msg.content}")
                        break
