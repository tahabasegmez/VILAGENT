...
This helper is intentionally manual. VILAGENT runtime does not probe Keychain.
Use this script when you want to bridge an existing Claude Code login into an
environment variable or an exported credentials file for VILAGENT.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Manually export Claude Code OAuth credentials from macOS Keychain for VILAGENT.",
    )
    parser.add_argument(
        "--service",
