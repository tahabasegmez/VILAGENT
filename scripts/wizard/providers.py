...
LLM_PROVIDERS: list[LLMProvider] = [
    ...
    LLMProvider(
        ...
        use="vilagent.models.vllm_provider:VllmChatModel",
    ...
    LLMProvider(
        ...
        use="vilagent.models.openai_codex_provider:CodexChatModel",
    ...
    LLMProvider(
        ...
        use="vilagent.models.claude_provider:ClaudeChatModel",
...
SEARCH_PROVIDERS: list[SearchProvider] = [
    ...
    SearchProvider(
        ...
        use="vilagent.community.tavily.tools:web_search_tool",
    ...
    SearchProvider(
        ...
        use="vilagent.community.infoquest.tools:web_search_tool",
    ...
    SearchProvider(
        ...
        use="vilagent.community.exa.tools:web_search_tool",
        env_var="EXA_API_KEY",
        extra_config={
            "max_results": 5,
            "search_type": "auto",
    ...
    SearchProvider(
        ...
        use="vilagent.community.firecrawl.tools:web_search_tool",
...
WEB_FETCH_PROVIDERS: list[WebProvider] = [
    ...
    WebProvider(
        ...
        use="vilagent.community.exa.tools:web_fetch_tool",
        env_var="EXA_API_KEY",
        tool_name="web_fetch",
    ),
    WebProvider(
        ...
        display_name="InfoQuest",
        description="API key required",
        use="vilagent.community.infoquest.tools:web_fetch_tool",
        env_var="INFOQUEST_API_KEY",
        tool_name="web_fetch",
    ...
    WebProvider(
        ...
        use="vilagent.community.firecrawl.tools:web_fetch_tool",
        env_var="FIRECRAWL_API_KEY",
        tool_name="web_fetch",
    ),
]
