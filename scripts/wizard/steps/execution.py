...
LOCAL_SANDBOX = "vilagent.sandbox.local:LocalSandboxProvider"
CONTAINER_SANDBOX = "vilagent.community.aio_sandbox:AioSandboxProvider"
...
def run_execution_step(step_label: str = "Step 3/4") -> ExecutionStepResult:
    ...
    print_info("Choose how much execution power VILAGENT should have in this workspace.")
